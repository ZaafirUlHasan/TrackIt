# Gaming Hour Tracker Application
...
```
cd existing_repo
git remote add origin https://gitlab.cci.drexel.edu/fds23/63/team-9/gaming-hour-tracker-application.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cci.drexel.edu/fds23/63/team-9/gaming-hour-tracker-application/-/settings/integrations)
