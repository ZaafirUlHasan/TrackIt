...
for segment in data['data']["segments"]:
    if segment["type"] == "legend":
        ...
        #First dictionary created:
        legend_stats[legend_name] = {
                    "kills": kills,
                    "winning kills": winning_kills,
...
overall_stats = {
            ...
            "approximate playtime minutes" : timeConvertor(approximate_playtime_minutes)
...
print(f'Based on an average match length of 15 minutes, your total playtime is approximately {approximate_playtime_minutes} minutes')
print(f'That\'s {timeConvertor(approximate_playtime_minutes)}!\n')
