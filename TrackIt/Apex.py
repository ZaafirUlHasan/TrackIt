...
import requests
import json
Apex = Blueprint(__name__, "Apex")


#Apex Legends
@Apex.route("ApexLegends.html")
def goToApexLegends():
    return render_template("ApexLegends.html")
...
def getApexStats():
    if request.method == 'POST':
            return redirect(url_for('Apex.getUsernameAndPlatform')) #Make sure to get Username AND Platform
